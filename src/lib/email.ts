      ...
      <div style="font-family:Inter,sans-serif;max-width:560px;margin:0 auto;background:#fff;border-top:6px solid #534AB7">
        <div style="padding:40px 40px 20px">
          ...
          <a href="${process.env.NEXTAUTH_URL}/dashboard/statements"
             style="display:inline-block;background:#534AB7;color:#fff;text-decoration:none;padding:12px 28px;border-radius:8px;font-size:14px;font-weight:600">
            View Statement →
          </a>
          <p style="font-size:12px;color:#999;margin:32px 0 0">If you have questions, contact <a href="mailto:support@elliceinvestmentgroup.com" style="color:#534AB7">support@elliceinvestmentgroup.com</a></p>
        </div>
